...
theta3=read.csv('simul\\results\\theta3.csv'); colnames(theta3)=nomes
theta5=read.csv('simul\\results\\theta5.csv'); colnames(theta5)=nomes
...
png('simul\\derived\\boxplot3.png',width=700,height=700)
...
png('simul\\derived\\boxplot5.png',width=700,height=700)
par(mfrow=c(1,1),mar=c(5,5,1,1))
