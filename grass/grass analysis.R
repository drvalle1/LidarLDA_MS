...
#re-order theta and combine with coordinates
order1=c(3,2,4,1)
...
coord.sel=read.csv('grass\\coord select.csv')
...
#get grass raster
grama <- raster('grass\\Grass2015.tif')
...
png('grass\\grass analysis scatter.png',width=700,height=700)
...
#save plot
ggsave(file='grass\\grass analysis pgrass.jpeg', 
...
ggsave(file='grass\\grass analysis gr1.jpeg', 
...
ggsave(file='grass\\grass analysis legend.jpeg', res2,width=7,height=(diffy/diffx)*7)  
